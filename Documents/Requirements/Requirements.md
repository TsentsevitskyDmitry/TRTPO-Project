...
3.1.1.3 [Просмотр напоминаний](#list_reminds)  
3.1.1.4 [Откладывание напоминаний](#readd_remind)  
3.1.1.5 [Переадресация напоминаний](#send_external)  
...
Приложение работает в любом Tellegram клиенте, но более старые версии лишены поддержки кнопок. 
...
#### 3.1.1.4 Откладывание напоминаний
...
#### 3.1.1.5 Переадресация напоминаний
...
1. Удобный способ добавления напоминаний;
2. Обратная связь с пользователем

<a name="security_requirements"/>

#### 3.2.1.2 Требования к безопасности
Приложение предоставляет возможность просмотра и редактирования напоминаний только активного пользователя.